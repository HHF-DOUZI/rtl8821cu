...
###################### Platform Related #######################
CONFIG_PLATFORM_alientek = y
CONFIG_PLATFORM_AR9341 = n
...
KSRC := /home/liam/work/plane/ar9341/H717EE_prj/base/arsdk/platforms/kernel/linux-linaro-stable-lsk-v4.9-17.07
MODULE_NAME := wlan
endif

ifeq ($(CONFIG_PLATFORM_alientek), y)
EXTRA_CFLAGS += -DCONFIG_LITTLE_ENDIAN -DCONFIG_IOCTL_CFG80211 -DRTW_USE_CFG80211_STA_EVENT
ARCH := arm
CROSS_COMPILE := /opt/arm-tools-chain/gcc-linaro-4.9.4-2017.01-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-
KSRC := /home/dl/workspace/NXP_uboot_linux/kernel_alientek
